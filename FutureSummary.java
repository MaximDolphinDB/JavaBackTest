...
public class FutureSummary extends Summary{
    ...
    public FutureSummary update(FutureSummary sum, Double price, Double vol, Double static_profit, Double static_loss, Double dynamic_profit, Double dynamic_loss){
        // 更新基本属性
